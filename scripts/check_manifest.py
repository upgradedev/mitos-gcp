...
Two layers use this module and must agree, which is the whole point of it being
a module rather than a check written twice:
...
def main(argv: list[str]) -> int:
    if len(argv) != 2:
        print("usage: check_manifest.py <url of /github/app/new>", file=sys.stderr)
        return 2
